...
def test_apply_locals_discount(self):
        self.cart.apply_locals_discount(True)
...
def num_surfboards(self, quantity=1):
    if self.num_surfboards + quantity > 4:
        print(surfshop.TooManyBoardsError("Cart cannot have more than 4 surfboards in it!"))
...
""""def test_checkout_date_in_future(self):
